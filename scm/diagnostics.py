...
def equilibrium_stats(diag_history, last_n=50):
    ...
    for key in ['ts', 'olr', 'asr', 'toa_net', 'precip_total', 'precip_conv',
                ...
                'lhf_potential', 'land_lhf', 'ocean_lhf', 'land_fraction',
                'ocean_fraction', 'sea_ice_fraction', 'glacier_fraction',
                'surface_fraction_sum', 'surface_albedo',
                'exchange_coefficient_heat', 'exchange_coefficient_moisture',
                'roughness_length', 'surface_type', 'land_use_type',
                'soil_type', 'topography',
                'soil_evap_beta', 'soil_moisture', 'soil_moisture_fraction',
                'soil_temperature', 'snow_water_equivalent', 'sea_ice_thickness',
                'soil_precipitation_rate', 'soil_evaporation_rate',
                'runoff_rate', 'drainage_rate',
                'composition_co2', 'composition_ch4', 'composition_n2o',
                'composition_o3', 'composition_o3_lw_tau', 'composition_o3_sw_tau',
                'composition_aerosol_optical_depth',
                'chemistry_surface_emissions', 'chemistry_dry_deposition_velocity',
                'chemistry_wet_deposition_rate',
                ...
                'hydrostatic_work_tendency', 'atmos_mse_residual',
                'slab_energy_tendency',
...
def energy_balance(state, diag):
    ...
    return {
        ...
        'hydrostatic_work_tendency': diag.get('hydrostatic_work_tendency'),
