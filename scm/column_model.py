...
def step(state, grid, params, rad_cache=None):
    ...
    diag = {
        ...
        'clear_sky_olr': rad_out.get('clear_sky_olr', torch.zeros_like(state['ts'])),
        'clear_sky_asr': rad_out.get('clear_sky_asr', torch.zeros_like(state['ts'])),
        'clear_sky_toa_net': rad_out.get('clear_sky_toa_net', torch.zeros_like(state['ts'])),
        'cloud_lw_cre': rad_out.get('cloud_lw_cre', torch.zeros_like(state['ts'])),
        'cloud_sw_cre': rad_out.get('cloud_sw_cre', torch.zeros_like(state['ts'])),
