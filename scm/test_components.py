...
def test_energy_budget_diagnostics(device):
    ...
    for key in [
        ...
        'atmos_mse_tendency', 'hydrostatic_work_tendency', 'atmos_mse_residual',
    ...
    assert torch.allclose(diag['atmos_mse_residual'], diag['atmos_energy_residual'])
    assert torch.allclose(diag['column_mse_residual'], diag['column_energy_residual'])
