...
def extract_param_overrides(config):
    ...
    if mass_flux:
        params.update(_non_null_items({
            ...
            "mf_downdraft_fraction": mass_flux.get("downdraft_fraction"),
            "mf_downdraft_start_sigma": mass_flux.get("downdraft_start_sigma"),
            "mf_downdraft_entrainment": mass_flux.get("downdraft_entrainment"),
            "mf_downdraft_detrainment": mass_flux.get("downdraft_detrainment"),
            "mf_downdraft_release": mass_flux.get("downdraft_release"),
            "mf_downdraft_release_sigma": mass_flux.get("downdraft_release_sigma"),
            "mf_downdraft_rain_share": mass_flux.get("downdraft_rain_share"),
            "mf_rain_evap_coefficient": mass_flux.get("rain_evap_coefficient"),
            "mf_subsidence_drying": mass_flux.get("subsidence_drying"),
            "mf_plume_count": mass_flux.get("plume_count"),
            "mf_plume_entrainment_spread": mass_flux.get("plume_entrainment_spread"),
