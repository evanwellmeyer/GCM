...
def edmf_boundary_layer(state, grid, params):
    ...
    return {
        ...
        'tke_production': local['tke_production'],
        'tke_dissipation': local['tke_dissipation'],
        'tke_transport': local['tke_transport'],
        'surface_buoyancy_flux_m2s3': local['surface_buoyancy_flux_m2s3'],
